...
PID control is really an interesting and excellent algorithm. The detail information can be found at [Wikipedia](http://en.wikipedia.org/wiki/PID_controller). The main point is that the control system has 3 parts: the Proportional, the Integral and the Derivative.
